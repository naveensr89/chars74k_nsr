...
open('xyz.json', 'w').write(json_string)
model.save_weights('xyz.h5')

#load model
model = model_from_json(open('xyz.json').read())
...
save_out(y_te,labels_string,sorted_files_te,'submission/testLabels_cifar10_CNN.csv')